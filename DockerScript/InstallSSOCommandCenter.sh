...
sudo docker exec  $cc_container_id java -jar /usr/local/tomcat/lib/Lingoport_Resource_Manager_Server-9.2-Installer.jar /usr/local/tomcat/auto-install.xml
